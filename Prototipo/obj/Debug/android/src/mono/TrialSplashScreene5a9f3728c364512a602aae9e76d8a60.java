...
public class TrialSplashScreene5a9f3728c364512a602aae9e76d8a60 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreene5a9f3728c364512a602aae9e76d8a60.this, prototipo.Navigator.class);
