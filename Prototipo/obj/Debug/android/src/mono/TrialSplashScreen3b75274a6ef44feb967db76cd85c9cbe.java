...
public class TrialSplashScreen3b75274a6ef44feb967db76cd85c9cbe extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen3b75274a6ef44feb967db76cd85c9cbe.this, prototipo.Navigator.class);
