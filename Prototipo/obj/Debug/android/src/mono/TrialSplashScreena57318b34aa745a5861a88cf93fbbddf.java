...
public class TrialSplashScreena57318b34aa745a5861a88cf93fbbddf extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreena57318b34aa745a5861a88cf93fbbddf.this, prototipo.Navigator.class);
