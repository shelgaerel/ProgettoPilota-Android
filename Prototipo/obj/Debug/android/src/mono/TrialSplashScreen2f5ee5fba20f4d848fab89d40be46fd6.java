...
public class TrialSplashScreen2f5ee5fba20f4d848fab89d40be46fd6 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen2f5ee5fba20f4d848fab89d40be46fd6.this, prototipo.Navigator.class);
