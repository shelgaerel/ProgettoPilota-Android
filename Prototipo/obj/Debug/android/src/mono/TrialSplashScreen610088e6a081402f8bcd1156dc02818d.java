...
public class TrialSplashScreen610088e6a081402f8bcd1156dc02818d extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen610088e6a081402f8bcd1156dc02818d.this, prototipo.Navigator.class);
