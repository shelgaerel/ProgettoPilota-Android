...
public class TrialSplashScreen285d097e3acc4bfa9173c721bfd7d8ec extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen285d097e3acc4bfa9173c721bfd7d8ec.this, prototipo.Navigator.class);
