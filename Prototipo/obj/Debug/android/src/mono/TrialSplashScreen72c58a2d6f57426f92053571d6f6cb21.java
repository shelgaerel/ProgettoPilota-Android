...
public class TrialSplashScreen72c58a2d6f57426f92053571d6f6cb21 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen72c58a2d6f57426f92053571d6f6cb21.this, prototipo.Navigator.class);
