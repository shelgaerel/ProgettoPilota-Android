...
public class TrialSplashScreen51c41b79a0f14cd9b454481490efb7d9 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen51c41b79a0f14cd9b454481490efb7d9.this, prototipo.Navigator.class);
