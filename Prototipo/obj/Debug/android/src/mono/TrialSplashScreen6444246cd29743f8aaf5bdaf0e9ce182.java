...
public class TrialSplashScreen6444246cd29743f8aaf5bdaf0e9ce182 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen6444246cd29743f8aaf5bdaf0e9ce182.this, prototipo.Navigator.class);
