...
public class TrialSplashScreenae7dc4d4aef24791a71307fbfd6aaf94 extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenae7dc4d4aef24791a71307fbfd6aaf94.this, prototipo.Navigator.class);
