...
public class TrialSplashScreenf567ced7073c486eb0377d8160125edc extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenf567ced7073c486eb0377d8160125edc.this, prototipo.Navigator.class);
