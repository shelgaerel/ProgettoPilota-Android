...
public class TrialSplashScreenbdc6a28b6f1b4d498bbd8a04ae305c6b extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreenbdc6a28b6f1b4d498bbd8a04ae305c6b.this, prototipo.Navigator.class);
